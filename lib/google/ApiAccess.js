...
const EXPIRY_GAP = 5 * 60 * 1000  // allow at least 5 minutes in ms
...
class ApiAccess {
  ...
  isLoggedIn(req) {
    const result = this.client.credentials && 
                  this.client.credentials.access_token && 
                  this.userName &&
                  this.client.credentials.expiry_date && 
                  this.client.credentials.expiry_date > Date.now() +  EXPIRY_GAP
    return result
  }
